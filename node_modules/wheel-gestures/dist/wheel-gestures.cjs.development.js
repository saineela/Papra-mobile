...
function WheelGestures(optionsParam) {
  ...
  var processWheelEventData = function processWheelEventData(wheelEvent) {
    ...
    var nativeMomentum = typeof wheelEvent.momentum === 'boolean' ? wheelEvent.momentum : undefined;
    ...
    else if (state.isMomentum && (nativeMomentum === false || nativeMomentum === undefined && deltaMaxAbs > Math.max(2, state.lastAbsDelta * 2))) {
        end(true);
        start();
